...
public class ReviewController {
	...
	@GetMapping
	public String index(@PathVariable("restaurantId") Integer restaurantId,
	...
	public String edit(@PathVariable("restaurantId")Integer restaurantId,
		...
		if(optionalRestaurant.isEmpty()||optionalReview.isEmpty()) {
			...
			return "redirect:/restaurants/{reustaurantId}";
		}
	...
	public String update(@PathVariable("restaurantId")Integer restaurantId,
						@PathVariable("reviewId")Integer reviewId,
						RedirectAttributes redirectAttributes,
						@AuthenticationPrincipal UserDetailsImpl userDetailsImpl,
